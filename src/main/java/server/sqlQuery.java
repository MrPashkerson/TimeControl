...
public class sqlQuery {
    ...
    public static final String SELECT_QUERY_EQUIPMENT = "SELECT * FROM equipment";
    ...
    public String selectAllStatistics() throws SQLException {
        ResultSet resultSet = statement.executeQuery(SELECT_QUERY_STATISTICS);
        StringBuilder result = new StringBuilder();
        while (resultSet.next()) {
            result.append(resultSet.getString(1)).append("; ").append(resultSet.getString(2)).append("; ").append(resultSet.getString(3)).append("; ").append(resultSet.getString(4)).append("\n");
        }
